...
def get_files_info(path):
	...
	print 'infos,file_paths',infos,file_paths
...
class MyFrame(Frame):
	...
	def init_components(self):
		...
		self.bak_src_var.set('/Users/xiangmin/projects/chatRoom/sample')
	...
	def start_send(self):
		...
		'''
		port = int(self.remote_ports_var.get())
		host = self.remote_ip_var.get()
		src = self.bak_src_var.get()
		t = threading.Thread(target = start,args = (host,port,src))
		t.start()
		#t.join()
		'''
